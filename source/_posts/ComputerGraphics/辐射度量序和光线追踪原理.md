...
2. 概念：
    ...
    3. 立体角$\omega$（针对球面坐标系），类比于平面角（针对极坐标系）：
        ...
        ![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%202.png)
    ...
    5. 辐照度$E$(Irradiance)，表示单位面积的辐射通量：
        ...
        ![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%203.png)
    ...
    6. 辐射率$L$(Radiance)，又叫光亮度。这是最常用（最重要）的一个物理量，也是构建渲染方程的主要物理量。他每表示单位立体角，每单位垂直面积的辐射通量。很像是Intensity和irradiance的结合。**它同时指定了光的方向与照射到的表面所接受到的亮度**。（就是这个单位面积在某个方向上吸收的光能）
        ...
        ![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%204.png)
        ...
        ![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%205.png)
        
        > 关于Radiance和Irradiance的理解：Radiance就表示该平面沿着某一个方向上吸收到的光能，这个微小发光面吸收到的所有能量之和就是Irradiance，等于所有Radiance的积分
        > 
        
        ![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%206.png)
    
3. BRDF函数（双向反射分布函数）

![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%207.png)
...
![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%208.png)
...
![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%209.png)
...
![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%2010.png)
...
![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%2011.png)

可以发现，当光源特别小的时候，光线很难去追踪。可以采用逆向思维解决，从光源追踪就可以。

![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%2012.png)
...
![Untitled](rs57jsdsf.hn-bkt.clouddn.com/img/Untitled%2013.png)
