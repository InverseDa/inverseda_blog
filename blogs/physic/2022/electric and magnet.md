...
这其实是个历史问题。最先确实引入了磁场强度$\vec{H}$，但后来发现磁场强度这个物理量无法解释很多电磁现象。所以我们为了方便研究磁场，导出了磁感应强度$\vec{B}$：
...
故
$$
F=\int BIdl=BI\int dl=BI\int l\cos \theta \ dl=BIL
$$
...
**实例**：已知带有边界的匀强磁场宽度为$L$，带负电的粒子出磁场的时候速度方向与水平夹角为$\theta$，已知磁感强度为$B$，求关于$q、B、m$的方程：

<img src="C:\Users\inver\AppData\Roaming\Typora\typora-user-images\image-20211127184400731.png" alt="image-20211127184400731" style="zoom: 25%;" />

解：① 定圆心

我们先对两个边界点进行受力分析，并画出两个洛伦兹力线：

<img src="C:\Users\inver\AppData\Roaming\Typora\typora-user-images\image-20211127184520764.png" alt="image-20211127184520764" style="zoom:33%;" />

这样就轻松确定了圆心。

② 找半径

通过几何知识，我们可以利用三角函数求出几何半径：

<img src="C:\Users\inver\AppData\Roaming\Typora\typora-user-images\image-20211127184635563.png" alt="image-20211127184635563" style="zoom: 33%;" />

得到
$$
R=\delta(L,θ)=\frac{L}{\sin\theta}
$$
说明这个是几何半径

（注意，考试的时候答题卡不要出现$\delta(L,θ)$）



接下来我们需要找到方程，所以得引入磁场半径：
$$
R=\frac{mv}{qB}
$$
所以联立磁场半径和几何半径，就有：
$$
\frac{mv}{qB}=\frac{L}{\sin\theta}
$$
这是我们的方程了。
...
正交电磁场的概念是匀强电场和匀强磁场正交，也就是$\vec{B}⊥\vec{E}$，所以磁场和电场要垂直。具体模型长这样：（以下示例为正电荷）

<img src="C:\Users\inver\AppData\Roaming\Typora\typora-user-images\image-20211127185226834.png" alt="image-20211127185226834" style="zoom: 25%;" />
...
![img](https://bkimg.cdn.bcebos.com/pic/0e2442a7d933c89540d2f474d11373f082020014?x-bce-process=image/watermark,image_d2F0ZXIvYmFpa2U4MA==,g_7,xp_5,yp_5/format,f_auto)
